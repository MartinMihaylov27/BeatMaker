...
while run:
    ...
    screen.blit(add_text, (520, HEIGHT - 136))
    screen.blit(sub_text, (524, HEIGHT - 87))

    #changing amount of beats
    ...
    screen.blit(beats_text2, (687, HEIGHT - 100))
    ...
    screen.blit(add_text2, (820, HEIGHT - 136))
    screen.blit(sub_text2, (824, HEIGHT - 87))
    ...
    #reset board
    reset_button = pygame.draw.rect(screen, gray, [1150, HEIGHT - 150, 200, 100], 0, 5)
    reset_text = label_font.render('Reset Board', True, white)
    screen.blit(reset_text, (1160, HEIGHT - 115))
